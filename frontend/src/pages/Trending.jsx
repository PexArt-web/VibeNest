...
const Trending = () => {
  return (
    <div className="min-h-screen pt-16 bg-gray-900 text-white">
        <div className="p-4 max-w-xl mx-auto bg-gray-800">
      <h2 className="text-xl font-bold mb-4 text-purple-600">Trending on VibeNest</h2>
      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden">
        {trendingTopics.map((trend, index) => (
          ...
          >
            ...
            <h3 className="text-md font-semibold text-gray-800">{trend.title}</h3>
